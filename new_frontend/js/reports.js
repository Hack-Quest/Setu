...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    /**
     * 1. THE SAFETY SHIELD
     * Force-hides the loader after 5 seconds to prevent hanging on missing icons.
     */
    ...
    try {
        ...
        if (result.ok && reports.length > 0) {
            if (reportsList) {
                ...
                reportsList.innerHTML = ''; // Clear "Syncing..." text
            }
            ...
            sortedData.forEach((report, index) => {
                ...
                const trustOrVerificationHtml = showTrustScore
                    ...
                    : `Verification: ${report.status || 'Pending'}`;
                ...
                // 5. MAP INTEGRATION (Leaflet / OSM Version)
